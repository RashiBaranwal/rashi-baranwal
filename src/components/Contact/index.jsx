        ...
        <div className="contact__group">
          <div className="contact__options">
            <article className="contact__option">
              ...
              <h3>Email</h3>
              <h5>rashi1704baranwal@gmail.com</h5>
              <a
                href="mailto:rashi1704baranwal@gmail.com"
                target="_blank"
                className="btn"
              >
                Send a message
            ...
            <article className="contact__option">
              ...
              <h3>Telegram</h3>
              <h5>rashi1704baranwal@gmail.com</h5>
              <a href="http://t.me/rashi_b04" target="_blank" className="btn">
                Send a message
              </a>
            </article>
            <article className="contact__option">
              ...
              <h5>91+ 6392226838</h5>
              <a
                href="https://api.whatsapp.com/send?phone=6392226838"
                target="_blank"
                className="btn"
              >
                Send a message
