...
const Navbar = () => {
  ...
  return (
    <nav className={`navbar__container ${visible?"visible":""}`} ref={container}>
      ...
      <div className="navbar__buttons__group">
  <a href="https://drive.google.com/file/d/1vg3fiDAHS_zdyyhtUufnOOH6ZCCHeM3U/view?usp=sharing" target="_blank" rel="noopener noreferrer">
